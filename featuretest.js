...
function allocateLargestPossibleContiguousBlock(userAgentExplained) {
  ...
  var testLarge = [2*1024 - 16, 1024 + 768, 1024 + 512, 1024 + 256, 1024, 768 + 192, 768 + 128, 768 + 64 + 32, 768 + 64, 768 + 32, 768, 640];
  ...
  if (userAgentExplained.productComponents['Firefox'] || (userAgentExplained.formFactor == 'Desktop' && userAgentExplained.bitness == 64)) {
    test = test.concat(testHuge);
  }

  // Test large sizes on all desktops.
  if (userAgentExplained.productComponents['Firefox'] || userAgentExplained.formFactor == 'Desktop') {
